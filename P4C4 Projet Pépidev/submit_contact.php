<!-- TRAITEMENT DE LA PRISE DE CONTACT DE LA PAGE 'contact.php'.
 le message est normalement envoyé au service SAV par mail, mais étant donné que le serveur est en local, cela n'est pas disponible dans la démo
l'image exportée est envoyée dans le dossier 'uploads' 
-->
<?php
...
if (isset($postData['message'])) { 
    // On peut valider envoyer le message par mail au SAV
    mail('contactSAV@recettes.com', $postData['email'], $postData['message']);
