<!-- PAGE DE MODIFICATION DE RECETTE QUAND ON CLIQUE SUR 'ajoutez une recette'  -->
<?php
session_start();
...
<body class="d-flex flex-column min-vh-100 mt-5 pt-4">
    <div class="container">
        ...
        <form action="recipes_post_update.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="picture" class="form-label">Téléchargez une image qui représente votre recette</label>
                <input type="file" class="form-control" id="picture" name="picture" />
                <div id="title-help" class="form-text">Vérifiez que l'image que vous utilisez est bien libre de droit.</div>
            </div>
